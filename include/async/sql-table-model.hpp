#ifndef ASYNC_SQLTABLE_MODEL_HPP
#define ASYNC_SQLTABLE_MODEL_HPP
...
class AsyncSqlTableModel : public QAbstractTableModel {
    ...
    private:
        ...
        QList<QSqlRecord> records_;
        QList<QSqlRecord> originalRecords_;
        QMap<int, QSqlRecord> updatedRecordMap_;
        QMap<int, QSqlRecord> originalUpdatedRecordMap_;
        QList<int> insertedRows_;
        QList<int> originalInsertedRows_;
        QList<int> removedRows_;
        QList<int> originalRemovedRows_;
...
#endif // ASYNC_SQLTABLE_MODEL_HPP
